<template>
  <div>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6" style="margin-left: 85%;margin-bottom:5px;margin-top:-5px">
...
export default {
  ...
  methods: {
    deleteSub(e) {
      ...
      this.axios
        .post("/wsyu/sub/deleteBySubject.htm", params)
        .then(
          function (response) {
    ...
    insert() {
      ...
      this.axios
        .post("/wsyu/sub/insertBySubject.htm", params)
        .then(
          function (response) {
            if (response.data.code == "0000") {
    ...
    queryPage() {
      ...
      this.axios
        .post("/wsyu/sub/queryPageBySubject.htm", params)
        .then(
          function (response) {
