      ...
      <el-table :data="tableData" height="550" border style="width: 100%">
        ...
        <el-table-column prop="type" label="操作" style="padding-left: 100%">
          <template slot-scope="scope">
            <el-button type="primary" @click="queryRoleMenu(scope.row.roleId)"
              >角色菜单配置</el-button
            >
...
export default {
  ...
  methods: {
    ...
    ok() {
      ...
      this.axios
        .post("/wsyu/menu/updateRoleMenuInfo.htm", params)
        .then(
          function (response) {
    ...
    queryRoleBaseQuery() {
      ...
      this.axios
        .post("/wsyu/role/rolePage.htm", params)
        .then(
          function (response) {
    ...
    insertRoleInfo() {
      ...
      this.axios
        .post("/wsyu/role/insertRoleInfo.htm", param)
        .then(
          function (response) {
            if (response.data.code == "0000") {
    ...
    deleteRole(sid) {
      ...
      this.axios
        .post("/wsyu/role/deleteRole.htm", param)
        .then(
          function (response) {
            if (response.data.code == "0000") {
    ...
    queryRoleMenu(roleId) {
      ...
      this.axios
        .post("/wsyu/menu/queryMenuListByRoleId.htm", params)
        .then(
          function (response) {
            this.menuShow = true;
      ...
      this.axios
        .post("/wsyu/menu/queryMenuIdListByRoleId.htm", params)
        .then(
          function (response) {
